...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
			    ...
			    switch($post_ft_type)
			    {
			    	...
			    	default:
			        	if(!empty($image_thumb))
			        	{
			        		...
			        		$blog_featured_img_alt = get_post_meta(get_post_thumbnail_id(get_the_ID()), '_wp_attachment_image_alt', true);
			?>
			
			    	    <div class="post_img static">
			    	    	<a href="<?php echo esc_url($large_image_url[0]); ?>" class="img_frame">
			    	    		<img src="<?php echo esc_url($small_image_url[0]); ?>" alt="<?php echo esc_attr($blog_featured_img_alt); ?>" class="" style="width:<?php echo esc_attr($small_image_url[1]); ?>px;height:<?php echo esc_attr($small_image_url[2]); ?>px;"/>
				            </a>
			    	    </div>
			...
			?>
			<?php dynamic_sidebar( 'timtom_post_1' ); ?>
			<?php
			...
			if ($tags) {
			 ...
			 ?>
			 	<br class="clear"/><br/>
			  	<h2 class="widgettitle"><span><?php echo _e( 'You might also like', 'photome' ); ?></span></h2><br class="clear"/><br/>
